...
const BASE_BUILD_COMMAND = `REACT_APP_COLLAB_PROJECT_KEY=${
  process.env.REACT_APP_COLLAB_PROJECT_KEY || ''
} REACT_APP_SENTRY_RELEASE=${RELEASE} REACT_APP_ENV=${process.env.REACT_APP_ENV} react-scripts build`;
