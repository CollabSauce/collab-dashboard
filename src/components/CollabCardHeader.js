...
const CollabCardHeader = ({ title, light, titleTag, titleClass, className, breakPoint, children }) => (
...
CollabCardHeader.defaultProps = { light: true };

export default CollabCardHeader;
